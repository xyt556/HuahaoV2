...
def Cust_Binarization():
    ...
    # plt.text(val + 0.02, 1000, 't* = ' + str(val), fontsize=12)
    # # plt.tight_layout()
    # plt.savefig("./otsu_image.png", dpi=96)
    #
    # plt.show()
    # canvas = tk.Canvas(root, bg='blue', height=360, width=600)
    # image_file = tk.PhotoImage(file='./otsu_image.png', )
    # canvas.create_image(300, 180, anchor = 'center', image=image_file, )
    # canvas.grid(columnspan=4, row=7)
...
if __name__ == '__main__':
    ...
    # canvas = tk.Canvas(root, bg='blue', height=160, width=600)
    # image_file = tk.PhotoImage(file='./otsu_image.png',)
